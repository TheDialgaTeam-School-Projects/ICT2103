...
<html lang="en">
<head>
    <title>Intake by Schools and Courses</title>
    <meta charset="utf-8">
            ...
            <table class="display" id="data_table" style="width: 100%">
                ...
                foreach ($documentsFromBatchSchoolCollection as $document): ?>
                    <tr>
                        ...
                        <?php if (isset($_SESSION['loggedIn'])): ?>
                            <td>
                                <a href="modify.php?from=intake&table=school&id=<?= $document['_id'] ?>">Modify</a> /
                                <a href="delete.php?from=intake&table=school&id=<?= $document['_id'] ?>">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
            ...
            <table class="display" id="data_table2" style="width: 100%">
                ...
                foreach ($documentsFromBatchCourseCollection as $document): ?>
                    <tr>
                        ...
                        <?php if (isset($_SESSION['loggedIn'])): ?>
                            <td>
                                <a href="modify.php?from=intake&table=course&id=<?= $document['_id'] ?>">Modify</a> /
                                <a href="delete.php?from=intake&table=course&id=<?= $document['_id'] ?>">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
