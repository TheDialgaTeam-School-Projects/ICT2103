            ...
            <table class="display" id="data_table" style="width: 100%">
                ...
                foreach ($documentsFromBatchSchoolCollection as $document): ?>
                    <tr>
                        ...
                        <td><?= $document['year'] ?></td>
                        <td><?= $document['enrolled'] ?></td>
                        <?php if (isset($_SESSION['type']) && $_SESSION['type'] == 'admin'): ?>
                            <td><?= $document['last_edited_by'] ?? "" ?></td>
                        <?php endif; ?>
                        <?php if (isset($_SESSION['loggedIn'])): ?>
                            <td>
                                <a href="modify.php?from=enroll&table=school&id=<?= $document['_id'] ?>">Modify</a> /
                                <a href="delete.php?from=enroll&table=school&id=<?= $document['_id'] ?>">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
            ...
            <table class="display" id="data_table2" style="width: 100%">
                ...
                foreach ($documentsFromBatchCourseCollection as $document): ?>
                    <tr>
                        ...
                        <?php if (isset($_SESSION['loggedIn'])): ?>
                            <td>
                                <a href="modify.php?from=enroll&table=course&id=<?= $document['_id'] ?>">Modify</a> /
                                <a href="delete.php?from=enroll&table=course&id=<?= $document['_id'] ?>">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
